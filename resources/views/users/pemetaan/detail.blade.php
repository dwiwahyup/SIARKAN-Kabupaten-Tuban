                                        ...
                                        <div class="col col-sm-6">
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td class="text-right">{{ $data->kondisi_jalan }}</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Kondisi Lingkungan</th>
                                                    <td>:</td>
                                                    <td class="text-right">{{ $data->kondisi_lingkungan }}</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Kondisi Kecelakaan</th>
                                                    <td>:</td>
                                                    <td class="text-right">{{ $data->kondisi_kecelakaan }}</td>
                                                </tr>
                                            </table>
                                        </div>
                                        <hr class="pt-0 mt-0">
                                        <div class="row pt-3">
                                            ...
                                            <div class="col-lg-6">
                                                @if ($data->tingkat_kerawanan == 'Tidak Rawan')
                                                    <a class="btn btn-green rounded-pill">{{ $data->tingkat_kerawanan }}</a>
